  ...
  return (
    <points ref={ref}>
      ...
      <pointsMaterial size={0.03} sizeAttenuation transparent opacity={0.38}
        color="#3B82F6" blending={THREE.AdditiveBlending} depthWrite={false} />
    </points>
  )
}
...
/* ─── CARD LAYOUT ─── */
const CARDS = [
  { url: "/photos/hero.jpeg", physicalIndex: 2, delay: 0, color: "#3B82F6" },
  { url: "/photos/photo7.jpeg", physicalIndex: 1, delay: 1.1, color: "#38BDF8" },
  { url: "/photos/photo5.jpeg", physicalIndex: 3, delay: 0.7, color: "#3B82F6" },
  { url: "/photos/photo2.jpeg", physicalIndex: 0, delay: 1.8, color: "#8B5CF6" },
  { url: "/photos/photo9.jpeg", physicalIndex: 4, delay: 1.4, color: "#38BDF8" },
]
...
export default function HeroScene({ mouseX = 0, mouseY = 0 }) {
  ...
  return (
    <Canvas camera={{ position: [0, 0, 12], fov: 55 }}
      ...
      <pointLight position={[-6, 4, 6]} intensity={3.8} color="#3B82F6" distance={24} />
      <pointLight position={[9, -3, 5]} intensity={2.8} color="#38BDF8" distance={20} />
      ...
      <AccentOrb position={[-9, 2.5, -7]} color="#3B82F6" size={0.20} speed={0.72} delay={0} />
      <AccentOrb position={[10.5, -2, -6]} color="#38BDF8" size={0.17} speed={1.0} delay={1.2} />
      <AccentOrb position={[2, 5.5, -9]} color="#8B5CF6" size={0.14} speed={0.58} delay={2.0} />

      <Sparkles count={55} scale={22} size={1.4} speed={0.22} color="#3B82F6" opacity={0.32} />
      <Particles count={450} />
    </Canvas>
  )
}
